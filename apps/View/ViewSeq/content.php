...
////////////////////////////////////////////////////////////////////////////
  ...
  $onc = "onClick='pindahData2(nocmt.value,nocolor.value,exftydate.value,typeseq.value)'";
  ...
  <?php //if ($_GET['cm'] || $_GET['co'] || $_GET['xty']){ ?>
     ...
     <?php //} ?>
          ...
          <div class="form-group">
            ...
            <label class="col-md-2 control-label" for="profileLastName"><b>New/Rework</label>
            <div class="col-md-4">
              <select data-plugin-selectTwo class="form-control populate"  placeholder="None Selected" name="typeseq" id="typeseq">
                <option value="0" <?php  if($_GET['typeseq'] == 0){echo "selected";}else{echo "";} ?>>All</option>
                <option value="1" <?php  if($_GET['typeseq'] == 1){echo "selected";}else{echo "";} ?>>New</option>
                <option value="2" <?php  if($_GET['typeseq'] == 2){echo "selected";}else{echo "";} ?>>Rework</option>
              </select>
            </div>
          </div>
          <div class="form-group">
              <div class="col-md-12">
                <a href="content.php?option=View&task=sequence&act=ugr_view" style="height:30px; line-height: 0;float: right; padding: 2%;" type="button" class="btn btn-default">Reset</a>
