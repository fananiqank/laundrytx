...
expcolor6 = expcolor5.split('&');
	...
	'use strict';
		...
		var datatableInit = function() {
			...
			$table.dataTable({
				"processing": true,
	         	"serverSide": true,
	        	"ajax": "apps/View/ViewSeq/data.php?cm="+cmts+"&co="+color+"&xty="+xty+"&typeseq="+typesq,
 ...
 //        var spintable = $('#datatable-ajax').DataTable({
	// 			"processing": true,
	// 			"serverSide": true,
	// 			"ajax": "apps/View/ViewSeq/data.php?cm="+cmts+"&co="+color+"&xty="+xty,
 ...
 //    	// }
	...
	function pindahData2(cmt,colors,exftydate,typeseq){
	 	...
	 	if (cmt == '') {
			...
			expcolor = trimcolor.split('#');
	 		...
	 		expcolor6 = expcolor5.split('&');
	 		 ...
	 		 var hal = $('#getp').val();
			 window.location="content.php?"+hal+"&cm="+cmts+"&co="+color+"&xty="+exftydate+"&typeseq="+typeseq;
		}
	}
