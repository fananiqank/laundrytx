...
//mendapatkan id
foreach ($selcutqty = $con->select("laundry_wo_master_dtl_proc","wo_master_dtl_proc_id,wo_master_dtl_proc_status,rework_seq","wo_no = '$hslscan[wo_no]' and garment_colors = '$hslscan[garment_colors]'") as $cutqty ){}
	                        ...
	                        <div class="col-sm-12 col-md-12 col-lg-12" style="background-color: #FFFFFF; " />
	                            ...
	                            <table class="table datatable-basic table-bordered table-striped table-hover pre-scrollable" width="100%" id="datatable-ajax3" style="font-size: 13px;">
	                                ...
	                                <tbody id="tampilmodcart">
		                              ...
		                              <input type="hidden" name="createtype" id="createtype" value="<?=$cutqty[wo_master_dtl_proc_status]?>">
		                              <input type="hidden" name="reworkseq" id="reworkseq" value="<?=$cutqty[rework_seq]?>">
		                              <input type="hidden" name="mastertypelotid" id="mastertypelotid" value="<?=$subs?>">
