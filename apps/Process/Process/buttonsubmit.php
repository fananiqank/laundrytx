...
<div class="form-group"  style="font-size: 14px;">
	<div class="col-md-1" align="left">
  	...
  	if (($role1['master_type_process_id'] == 4 && $role1['master_process_id'] != '13' && $_SESSION[ID_LOGIN] == 832)  || 
  		($role1['master_type_process_id'] == 4 && $role1['master_process_id'] == '13' && $_SESSION[ID_LOGIN] == 870) || 
  		($role1['master_type_process_id'] == 5 && $_SESSION['ID_LOGIN'] == 833)) {
	...
	<?php } else if ($role1['dtl_process'] == '2'){ ?> <!--Process Out-->
			<a href="javascript:void(0)" class="btn btn-success" style="padding: 3%;background-color: #800000"  <?=$disend?> data-toggle='modal' data-target='#funModal' id='mod' onclick="modelend(3,'<?=strtoupper($_GET[lot])?>','<?=$role1[master_type_process_id]?>','<?=$role1[master_process_id]?>')"><b style="font-size:20px;">END</b></a>
	<?php 
		} 
	}  else {
		...
		} else if ($role1['master_type_process_id'] == 4 && $role1['master_process_id'] != '13' && $_SESSION['ID_LOGIN'] != 832) {
			echo "<a href='javascript:void(0)' class='btn btn-success' style='padding: 3%'><b style='font-size:14px;'>Go to Dry Process</b></a>";
		} else if ($role1['master_type_process_id'] == 4 && $role1['master_process_id'] == '13' && $_SESSION['ID_LOGIN'] != 870) {
			echo "<a href='javascript:void(0)' class='btn btn-success' style='padding: 3%'><b style='font-size:14px;'>Go to PP Spray Process</b></a>";
