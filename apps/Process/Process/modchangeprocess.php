					...
					<fieldset>
						...
						<div class="form-group">
						 	...
						 	<div class="col-md-6 col-lg-6">
								 <select data-plugin-selectTwo class="form-control select2 populate"  placeholder="None Selected" name="ccp" id="ccp">
						...
						<div class="form-group">
							...
							<div class="col-md-8 col-lg-8">
								<a href="javascript:void(0)" class="btn btn-primary" id="nextprocess" name="nextprocess" onclick="process_change(ccp.value)" data-dismiss="modal">Submit</a>&emsp;
								<a href="javascript:void(0)" class="btn btn-primary" id="nextprocess" name="nextprocess" onclick="process_change('reset')" data-dismiss="modal">Reset</a>
							</div>
						</div>
