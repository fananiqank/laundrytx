				...
				<div id="edit" class="tab-pane">
					...
					<?php } ?>
						...
						<div class="form-group">
							...
							<?php } else { ?>
								<a href="javascript:void(0)" class="btn btn-primary" id="nextprocess" name="nextprocess" onclick="process_end(3,'<?=$_GET[lot]?>','<?=$_GET[machine]?>','<?=$_GET[mpid]?>','<?=$_GET[q]?>')" data-dismiss="modal">Submit</a>
							<?php } ?>
