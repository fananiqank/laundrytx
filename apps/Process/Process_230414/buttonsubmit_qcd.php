<div class="form-group"  style="font-size: 14px;">
	<div class="col-md-1" align="left">
	   	...
	   	<a href="javascript:void(0)" class="btn btn-default" onclick="cancel()">Reset</a>
	
  	</div>
  	<div class="col-md-11" align="center">
  	<?php 
  	if ($role1['master_type_process_id'] == 3 || $role1['master_type_process_id'] == 6) {
  		if($role1['dtl_process'] == ''){  echo "qrc";
  	?> <!--Process IN-->
