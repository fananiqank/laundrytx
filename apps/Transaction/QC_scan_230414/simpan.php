...
//process End
	...
	if ($_POST['usemachine'] == 1) {
		$dataprocessmachine = array(	
						 'process_machine_qty_good' => $sqtygood,
						 'process_machine_qty_reject' => $sqtyreject,
						 'process_machine_qty_repair' => $sqtyrework,
						 'process_machine_qty_total' => $_POST['qty_process'],
						 'process_machine_qty_std' =>  $sqtystd,
		...
		//echo "update from laundry_process_machine set $dataprocessmachine where lot_no = '$_POST[lot_no_process]' and machine_id = '$_POST[machineid]'";
	}
