...
$columns = array(
	...
	array( "db" => "rec_no", 	"dt" => 6, "field" => "rec_no",
		'formatter' => function( $d, $row ) {
					...
					$isijum = " <a href='lib/phpqrcode/index.php?no=$d' class='label label-warning' style='cursor:pointer' target='_blank'><i class='fa fa-detail' aria-hidden='true' style='font-size:14px;'></i></a>
								<a href='lib/phpqrcode/index.php?no=$d' class='label label-warning' style='cursor:pointer' target='_blank'><i class='fa fa-print' aria-hidden='true' style='font-size:14px;'></i></a>";
