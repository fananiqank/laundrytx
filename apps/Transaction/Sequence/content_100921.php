...
<?php 
      ...
      $seltemplate = $con->select("laundry_role_wo_master A JOIN laundry_wo_master_dtl_proc B ON A.role_wo_master_id=B.role_wo_master_id","A.*,B.rework_seq","role_wo_master_status = 1","wo_no,rework_seq");
?>
...
<?php } ?>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4" style="display: block" id="buttontemplate">
