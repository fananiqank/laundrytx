...
$selseqwo = $con->select("laundry_role_wo A LEFT JOIN laundry_role_dtl_wo B ON A.role_wo_id = b.role_wo_id and B.role_dtl_wo_status = 1",
	     "A.role_wo_id,
		  ...
		  A.role_wo_seq,
		  B.role_dtl_wo_seq",
  		"role_wo_master_id='$_POST[role_wo_m_id]' and role_wo_seq > (select role_wo_seq from laundry_role_wo where role_wo_master_id = '$_POST[role_wo_m_id]' and master_type_process_id = 2)","role_wo_seq");
...
//jika role wo id sama tetapi role dtl wo kosong
				else if ($seqchild['role_wo_id'] == $sqw['role_wo_id'] && $sqw['role_dtl_wo_id'] == ""){
					//echo "c";
