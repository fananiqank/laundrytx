	...
	<tr>
		...
		<td width="20%">
			<?php if ($subcat['role_dtl_grup_id'] != '') { ?>
				...
				<a href="javascript:void(0)" class="btn btn-default" onclick="hapusroledtl(<?=$subcat[role_dtl_grup_id]?>,<?=$_GET[id]?>,<?=$_GET[j]?>,<?=$subcat[role_dtl_grup_seq]?>,0,0)"><i class="fa fa-trash"></i></a>
			<?php } else { ?>
