        ...
        <div class="form-group">
            <div class="col-sm-12 col-md-12 col-lg-12">
              <a href="content.php?p=<?=$_GET[p]?>" style="height:30px; line-height: 0;float: right; padding: 2%;" type="button" class="btn btn-default">Reset</a>
                <input style="height:30px; line-height: 0;float: right; padding: 2%;" type="button" class="btn btn-info" value="Search" onClick="pindahData3(wo_no.value,color_no.value,ex_fty_date_asli.value,typelot.value,usercode.value)">
            </div>
        </div>
</div>