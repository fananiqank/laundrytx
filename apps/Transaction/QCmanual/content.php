          ...
          <table width="100%" style="font-size: 16px;">
            <tr>
                ...
                <td>
                    ...
                    <a href="javacript:void(0)" class="btn btn-primary" style="margin-bottom: 0%;float: right;" data-toggle="modal" data-target="#funModalrec" id="mod" onclick="modelqc('M')">Confirm</a>
                </td>
            </tr>
          </table>
          <hr>
