...
<?php foreach ($selseqpro as $seqpro ) { ?>
  	<option value="<?php echo $seqpro[role_wo_master_id].'_'.$seqpro[wo_master_dtl_proc_id]; ?>"><?=$seqpro['role_wo_master_name'].' ('.$seqpro['color_wash'].') - Rework-'.$seqpro['rework_seq'].$seqpro['role_wo_master_remark']?></option>
<?php } ?>