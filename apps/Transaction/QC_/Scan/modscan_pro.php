...
//mendapatkan id
foreach ($selcutqty = $con->select("laundry_wo_master_dtl_proc","wo_master_dtl_proc_id,wo_master_dtl_proc_status,rework_seq","wo_no = '".$hslscan['wo_no']."' and garment_colors = '".$hslscan['garment_colors']."' and DATE(ex_fty_date) = '".$hslscan['ex_fty_date']."'") as $cutqty ){}
