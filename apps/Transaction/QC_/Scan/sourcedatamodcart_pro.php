...
<?php 
	...
	?>
		<tr>
			...
			<th><?php echo date('d-m-Y',strtotime($totscan['ex_fty_date']))?></th>
			...
			<th width="5%" style="text-align: center"><?php echo $totscan['totqty']?>
				<input type="hidden" id="datasave[]" name="datasave[]" value="<?php echo $datasave; ?>">
			</th>
		</tr>
	<?php 
		  $no++; 
	...
	<tr style="font-size: 16px;">
		<th width="5%" colspan="6" style="text-align: right"><b>Total</b></th>
		<th width="5%" style="text-align: center"><b><?php echo $sumqty['totqty']; ?></b>
			<input type="hidden" id="totalrec_<?php echo $grm[scan_status_garment]; ?>" name="totalrec_<?php echo $grm[scan_status_garment]; ?>" value="<?php echo $sumqty[totqty]; ?>">
			<input type="hidden" id="datarec[]" name="datarec[]" value="<?php echo $grm[scan_status_garment]; ?>">
		</th>
	</tr>
<?php 
...
<tr style="font-size: 16px;">
	...
	<th width="5%" style="text-align: center"><b><?php echo $supertotalall; ?></b>
		<input type="hidden" id="supertotalrec" name="supertotalrec" value="<?php echo $supertotalall; ?>">
	</th>
