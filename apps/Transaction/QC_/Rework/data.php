...
$primaryKey = 'lot_id';
$joinQuery = "from (select a.lot_id,a.lot_no,a.lot_type,a.role_wo_master_id,a.wo_no,a.garment_colors,b.ex_fty_date,to_char(ex_fty_date, 'DD-MM-YYYY') as ex_fty_date_show,lot_qty,lot_status from laundry_lot_number a JOIN laundry_wo_master_dtl_proc b on a.wo_master_dtl_proc_id=b.wo_master_dtl_proc_id) as ABC";  
...
$columns = array(
	...
	array( "db" => "lot_id", 	"dt" => 6, "field" => "lot_id" ,
