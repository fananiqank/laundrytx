...
<form class="form-user" id="formku" method="post" enctype="multipart/form-data">
  <div class="form-group" onload="document.getElementById('scanner').focus();">
    ...
    <input type="text" class="form-control" name="usercode" id="usercode" style="font-size: 14px;" onkeypress="onEnteruserin(event)" required><br>
  </div>
  ...
  <input type="text" class="form-control" name="scanner" id="scanner" style="font-size: 16px;height:40px;" onkeypress="onEnter(event,<?php echo $typescan; ?>)"><br>
