...
$totalqr = $con->selectcount("laundry_scan_qrcode a left join qrcode_factory_master b on a.factory_id=b.factory_id", "a.*,b.factory_name", "scan_status = 0 and scan_createdby = '" . $_SESSION['ID_LOGIN'] . "' and scan_type = 3", "scan_id");
$selscan = $con->select("laundry_scan_qrcode a left join qrcode_factory_master b on a.factory_id=b.factory_id", "a.*,b.factory_name", "scan_status = 0 and scan_createdby = '" . $_SESSION['ID_LOGIN'] . "' and scan_type = 3", "scan_id");
