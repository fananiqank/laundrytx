...
if ($_GET['id']){
	$sellotnumber = $con->select("laundry_lot_number","COUNT(lot_id) as qa","wo_master_dtl_proc_id = '$_GET[id]' and lot_jenis = 1");
	//echo "select COUNT(lot_id) as QA from laundry_lot_number where wo_master_dtl_proc_id = '$_GET[id]' and lot_jenis = 1";
