...
// 		});
	function edit(id){
		...
		//javascript: window.location.href="content.php?p="+getp;
		//alert(id);
		$.ajax({
			type: 'POST',
			url:  "apps/Master/Role/detailrole.php?p="+id+"&d=in",
				success: function() {
						$('#tampilrole').load("apps/Master/Role/detailrole.php?p="+id+"&d=in");
						$('#no_buyer').val(buyer);
						$('#no_style').val(style);
						$('#no_cmt').val(cmt);
						$('#no_color').val(color);
