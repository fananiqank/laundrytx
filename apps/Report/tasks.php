...
p {
 ...
 <?php
					$selmodagent = $con->select("trtasks a
          left join mtkategori d on a.id_kategori = d.id_kategori
          left join mtagent e on a.id_agent = e.id_agent
          left join mtpegawai f on e.id_pegawai = f.id_pegawai","a.*,d.nama_kategori,f.nama_pegawai",
          "a.id_tasks = '$_GET[id]'");
...
<table cellpadding="0" cellspacing="0" style="width:78%;">
    ...
    <tr>
   	  <td ><table width="70%" border="0">
   	    <tr>
   	      <td align="justify" style="width:24%;font-size:10px; "> No. Tasks</td>
   	      <td align="justify" style="width:5%;font-size:5px; ">:</td>
   	      <td align="justify" style="width:40%;font-size:10px; "><?=$mg['no_tasks']?></td>
        </tr>
   	    <tr>
   	      <td style="width:20%;font-size:10px; " align="justify" >Created Date</td>
   	      <td style="width:2%;font-size:5px;" align="justify" >:</td>
   	      <td style="width:40%;font-size:10px; " align="justify" ><?=date('d-m-Y H:i:s',strtotime($mg['created_date_tasks']))?></td>
        </tr>
        <tr>
          <td style="width:20%;font-size:10px; " align="justify" >Closed Date</td>
          <td style="width:2%;font-size:5px;" align="justify" >:</td>
          <td style="width:40%;font-size:10px; " align="justify" ><?=date('d-m-Y H:i:s',strtotime($mg['closed_date_tasks']))?></td>
        </tr>
   	    <!-- <tr>
   	      <td style="width:20%;font-size:10px; " align="justify" >Approved by</td>
   	      <td style="width:2%;font-size:5px;" align="justify" >:</td>
   	      <td style="width:40%;font-size:10px; " align="justify" ><?=$mg['tgl']?></td>
        </tr> -->
   	    <tr>
...
<table border="1" cellpadding="0" cellspacing="0" style="width: 98%">  
  ...
  <tr>
  	<td><p style="letter-spacing: 1px;text-indent: 15px;text-align: justify;vertical-align: top"><?php echo $mg['remark_tasks']; ?></p></td>
  </tr>
</table>
<br>
...
<table border="1" cellpadding="0" cellspacing="0" style="width: 98%">  
  ...
  <tr>
    <td><p>
                    <ul style="width: 50%">
                      <?php 
                            $selfb = $con->select("trfeedback","*","id_tasks = '$mg[id_tasks]'");
