...
<table class="table table-bordered table-hover pre-scrollable no-footer" id="datatable-ajax" width="175%">
      <thead align="center">
          <tr>
              <th colspan="23" style="text-align:center" ><h4>DAYLY WIP REPORT<br />
          ...
          <tr>
              ...
              <th width="10%" rowspan="2">Weeks</th>
              <th width="10%" rowspan="2">Place</th>
              <th width="10%" rowspan="2">Ex Fty Date</th>
              <th width="10%" rowspan="2">Wo No</th>
              <th width="10%" rowspan="2">Colors</th> 
              <th width="10%" rowspan="2">Buyer</th>
              <th width="10%" rowspan="2">Wash Category</th>
              <th width="10%" rowspan="2">Manual / Laser</th>
              <th width="10%" rowspan="2">First Incoming<br> Date</th>
              <th width="10%" rowspan="2">Status</th>
              <th width="5%" rowspan="2">First Bulk<br> Approval</th>
              <th width="15%" rowspan="2">Lead Time<br> Prebulk</th> 
              <th width="10%" rowspan="2">Cut Qty</th>
              <th width="15%" colspan="3" align="center">Receive</th>
              <th width="10%" rowspan="2">Sewing Balance</th>
              <th width="10%" rowspan="2">Take Out Sewing</th>
              <th width="10%" rowspan="2">Last Incoming <br> Date</th>
              <th width="10%" rowspan="2">Good Despatch</th>
              <th width="10%" rowspan="2">Reject</th>
              <th width="10%" rowspan="2">Total WIP</th>
              
          </tr>
          <tr>
              <th width="10%">Receive Scan</th>
              <th width="15%">Today <br> incoming</th>
              <th width="15%">Cumm</th>
